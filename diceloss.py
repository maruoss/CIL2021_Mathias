# Taken from https://github.com/hubutui/DiceLoss-PyTorch/blob/master/loss.py, 17.06.2021
...
class BinaryDiceLoss_Logits(nn.Module):
    ...
    def forward(self, predict, target):
        ...
        predict = torch.sigmoid(predict) # ADDED TORCH SIGMOID HERE FOR LOGITS INPUT
