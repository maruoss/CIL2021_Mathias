# Code adapted from CIL Tutorial3: https://colab.research.google.com/github/dalab/lecture_cil_public/blob/master/exercises/2021/Project_3.ipynb#scrollTo=ZFpPqQccO241
...
class Block(nn.Module):
    ...
    def __init__(self, in_ch, out_ch):
        super().__init__()
        self.block = nn.Sequential(nn.Conv2d(in_channels=in_ch, out_channels=out_ch, kernel_size=3, padding=1), # padding 1 preserves spatial size here. compared to original paper.
                                   nn.ReLU(),
                                   nn.BatchNorm2d(out_ch),
                                   nn.Conv2d(in_channels=out_ch, out_channels=out_ch, kernel_size=3, padding=1), # padding 1 preserves spatial size here. compared to original paper.
                                   nn.ReLU())
